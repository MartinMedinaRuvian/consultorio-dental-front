...
<div class="text-center">
    ...
    <div class="d-flex justify-content-center align-items-center container">
        <input @keypress="verPacientes()" type="text" class="form-control text-center formulario" placeholder="Ingrese el paciente" v-model="filtro">
        <button class="btn btn-outline-success" @click="verPacientes()"><span class="icon-Lupa"></span></button>
    </div>
